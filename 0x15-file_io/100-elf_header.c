 ...
 * @e_ident: pointer to arry containging ELF
 * if file is not ELF, exit code 98
 */
 ...
 * @e_ident: prointer to array containing ELF magic no.s
 * magic numbers are separated by space
 */
 ...
 * @e_ident: prointer to array containing ELF class
 */
 ...
 * @e_ident: prointer to array containing ELF version
 */
 ...
 * @e_ident: pointer to array containig the ELF ABI version
 */
 ...
 * @e_type: the ELF type
 * @e_ident: pointer ro array containing the ELF class
 */
...
/**
 * close_elf - close and ELF file
 * @elf: file descriptor of the ELF file
 * if file can not close, exi code 98
 */
...
/**
 * main - display info in ELF header at start of file
